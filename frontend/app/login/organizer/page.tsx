        ...
        <div className="flex items-center gap-0 bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 p-12 flex-col justify-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h1 className="text-5xl font-bold text-white mb-4">ORGANIZER</h1>
              <h2 className="text-2xl font-semibold text-blue-100 mb-6">Welcome Back</h2>
              <p className="text-blue-100/80 text-lg leading-relaxed">
                Sign in to manage your events, track ticket sales, and engage with attendees on your dashboard.
              </p>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2 p-8 md:p-12">
            <div className="max-w-md mx-auto">
              <h2 className="text-3xl font-bold text-gray-800 mb-2">Organizer Sign in</h2>
              <p className="text-gray-600 text-sm mb-8">Enter your credentials to manage events</p>

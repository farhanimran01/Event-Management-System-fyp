...
export default function AttendeeProfilePage() {
    ...
    const handleChangePassword = async (e: React.FormEvent) => {
        ...
        try {
            await api.put("/attendee/change-password", {
    ...
    const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            alert("Image upload not yet implemented in backend for Attendee specifically.");
        } catch (err: any) {
            setMessage({
                type: "error",
                ...
                <div className="lg:col-span-4 space-y-8">
                    <div className="bg-white p-8 rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col items-center text-center relative overflow-hidden group">
                        ...
                        <div className="relative mt-4">
                            ...
                            {/* Hidden Image Upload for now as backend support not confirmed for Attendee specific route */}
